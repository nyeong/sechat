...
router.get("/group/:group_id/calendar", (req, res) => {
...
router.get("/group/:group_id/calendar/events", (req, res) => {
  Group.findById(req.params.group_id)
    .populate("events")
    .then(group => {
...
router.post("/api/group/:group_id/calendar/event", (req, res) => {
...
router.delete("/api/group/:group_id/calendar/event/:event_id", (req, res) => {
  ...
  Group.findById(groupId).then(group => {
    ...
    group
      .save()
      .then(_ =>
        Event.findByIdAndDelete(eventId).then(_ => res.json({ success: true }))
      );
  });
});
